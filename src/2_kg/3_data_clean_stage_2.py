...
if __name__ == '__main__':
    # data_clean(input_path="../../data/2_kg/kg_data_1118_stage_3.json",
    #            already_done_path="../../data/2_kg/kg_data_1118_stage_3_already.json",
    #            output_path="../../data/2_kg/kg_data_1118_stage_4.json")

    # 数据筛查慢慢搞先导出一个用
    question2answer_list_clean = load_inputs("../../data/2_kg/kg_data_1118_stage_3.json")
    question2answer_list_clean = [{
        "instruction": question,
        "input": "",
        "output": answer
    ...
    print(f"End generating data and Clean, num: {len(question2answer_list_clean)}")
    # with open("../../data/2_kg/kg_data_1118_stage_3_output.json", 'w', encoding='utf-8') as f:
    #     json.dump(question2answer_list_clean, f, ensure_ascii=False, indent=4)

    data_analysis(question2answer_list_clean)
    # {50: 468, 100: 1228, 150: 348, 200: 84, 250: 19, 300: 13, 350: 4, 400: 0, 450: 0, 500: 0}